...
<html>
	<head>
		...
		<style type="text/css" media="screen">
			...
			#page-body {
				...
				background-image: url('${resource(dir: "images", file: "roadster.png")}');
				 height: 540px;
	...
	<div id="name">${ModelName }</div>
		...
		<table id="div1">
					...
					<g:form controller="buyer" action="comparison" params="['spec_id':4]" >
					<tr>
				...
				<table id="div2">
					...
					<tr>
						...
						<g:form controller="buyer" action="comparison" params="['spec_id':5]">
					<tr>
						<td><g:submitButton name="comparison" value="Compare"   /></td>
					</tr>
					</g:form>
