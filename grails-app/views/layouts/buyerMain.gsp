...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	<head>
		...
		<link rel="apple-touch-icon" sizes="114x114" href="${assetPath(src: 'apple-touch-icon-retina.png')}">
  		<asset:stylesheet src="buyerMain.css"/>
		<asset:javascript src="application.js"/>
		<g:layoutHead/>
	</head>
	<body>
	<div style="background-color:#C0C0C0; margin-bottom: -30px;height: 80px">
	<a href="localhost:8080/tesla/"><asset:image src="tesla.jpeg" alt="Grails" style="width:85px; height: 105px"/></a>
		<div id="teslaLogo" role="banner">
